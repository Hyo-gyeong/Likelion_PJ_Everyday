...
def new_detail_full(request, new_full_id):
    new_detail_full = get_object_or_404(List, pk = new_full_id)
    return render(request, 'new_detail_full.html', {'new_detail_full':new_detail_full})
